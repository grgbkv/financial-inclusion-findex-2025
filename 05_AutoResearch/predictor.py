"""Prediction stream — P2: per-target policy (current champion).
...
break that persistence badly misses. (P4 tried a logit-space damped trend for
account_t_d and lost to persistence by 0.02pp -- reverted; see RESEARCH_LOG.md.)
"""
import pandas as pd
